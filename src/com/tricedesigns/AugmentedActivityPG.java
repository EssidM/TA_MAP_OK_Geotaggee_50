...
public class AugmentedActivityPG extends SensorsActivity implements OnTouchListener {
    private static final String TAG = "AugmentedActivityPG";
    private static final DecimalFormat FORMAT = new DecimalFormat("#.##");
    private static final int ZOOMBAR_BACKGROUND_COLOR = Color.argb(125,55,55,55);
    private static final String END_TEXT = FORMAT.format(AugmentedActivityPG.MAX_ZOOM)+" km";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        augmentedView = new AugmentedView(this,1);
